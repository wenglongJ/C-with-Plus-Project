...
BEGIN_MESSAGE_MAP(CSINGLEApp, CWinAppEx)
...
// CSINGLEApp customization load/save methods

void CSINGLEApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSINGLEApp::LoadCustomState()
{
}

void CSINGLEApp::SaveCustomState()
{
}
