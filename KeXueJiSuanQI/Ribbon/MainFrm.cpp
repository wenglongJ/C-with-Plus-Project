...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_OPEN_BUTTON, &CMainFrame::OnOpenButton)
	ON_COMMAND(ID_Websites_COMBO, &CMainFrame::OnWebsitesCombo)
	ON_COMMAND(ID_Websites_CHECK, &CMainFrame::OnWebsitesCheck)
	ON_UPDATE_COMMAND_UI(ID_Websites_CHECK, &CMainFrame::OnUpdateWebsitesCheck)
	ON_UPDATE_COMMAND_UI(ID_Websites_COMBO, &CMainFrame::OnUpdateWebsitesCombo)
END_MESSAGE_MAP()
